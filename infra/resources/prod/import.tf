...
import {
  to = module.function_app_services.azurerm_key_vault_access_policy.function_services_itn_kv_common
...
import {
  to = module.function_app_services.azurerm_key_vault_access_policy.function_services_itn_slot_staging_kv_common
...
import {
  to = module.function_app_services.azurerm_storage_container.processing-messages-01
...
import {
  to = module.function_app_services.azurerm_storage_management_policy.processing_messages_container_rule_01
...
import {
  to = module.function_app_services.azurerm_storage_queue.message-created-01
  id = "https://iopitnservicesst02.queue.core.windows.net/message-created"
}

import {
  to = module.function_app_services.azurerm_storage_queue.message-created-poison-01
  id = "https://iopitnservicesst02.queue.core.windows.net/message-created-poison"
}

import {
  to = module.function_app_services.azurerm_storage_queue.message-processed-01
  id = "https://iopitnservicesst02.queue.core.windows.net/message-processed"
}

import {
  to = module.function_app_services.azurerm_storage_queue.message-processed-poison-01
  id = "https://iopitnservicesst02.queue.core.windows.net/message-processed-poison"
}

import {
  to = module.function_app_services.azurerm_storage_queue.notification-created-email-01
  id = "https://iopitnservicesst02.queue.core.windows.net/notification-created-email"
}

import {
  to = module.function_app_services.azurerm_storage_queue.notification-created-email-poison-01
  id = "https://iopitnservicesst02.queue.core.windows.net/notification-created-email-poison"
}

import {
  to = module.function_app_services.azurerm_storage_queue.notification-created-webhook-poison-01
  id = "https://iopitnservicesst02.queue.core.windows.net/notification-created-webhook-poison"
}

import {
  to = module.function_app_services.module.function_services.azurerm_linux_function_app.this
...
import {
  to = module.function_app_services.module.function_services.azurerm_linux_function_app_slot.this["0"]
...
import {
  to = module.function_app_services.module.function_services.azurerm_monitor_metric_alert.function_app_health_check["0"]
...
import {
  to = module.function_app_services.module.function_services.azurerm_monitor_metric_alert.storage_account_health_check["0"]
...
import {
  to = module.function_app_services.module.function_services.azurerm_private_endpoint.function_sites
...
import {
  to = module.function_app_services.module.function_services.azurerm_private_endpoint.st_blob
...
import {
  to = module.function_app_services.module.function_services.azurerm_private_endpoint.st_file
...
import {
  to = module.function_app_services.module.function_services.azurerm_private_endpoint.st_queue
...
import {
  to = module.function_app_services.module.function_services.azurerm_private_endpoint.staging_function_sites["0"]
...
import {
  to = module.function_app_services.module.function_services.azurerm_role_assignment.function_storage_account_contributor
...
import {
  to = module.function_app_services.module.function_services.azurerm_role_assignment.function_storage_blob_data_owner
...
import {
  to = module.function_app_services.module.function_services.azurerm_role_assignment.function_storage_queue_data_contributor
...
import {
  to = module.function_app_services.module.function_services.azurerm_role_assignment.staging_function_storage_account_contributor["0"]
...
import {
  to = module.function_app_services.module.function_services.azurerm_role_assignment.staging_function_storage_blob_data_owner["0"]
...
import {
  to = module.function_app_services.module.function_services.azurerm_role_assignment.staging_function_storage_queue_data_contributor["0"]
...
import {
  to = module.function_app_services.module.function_services.azurerm_service_plan.this["0"]
...
import {
  to = module.function_app_services.module.function_services.azurerm_storage_account.this
...
import {
  to = module.function_app_services.module.function_services.azurerm_storage_account_network_rules.st_network_rules
  id = "/subscriptions/ec285037-c673-4f58-b594-d7c480da4e8b/resourceGroups/io-p-itn-platform-services-rg-02/providers/Microsoft.Storage/storageAccounts/iopitnservicesstfn02"
}

import {
  to = module.function_app_services.module.function_services.azurerm_subnet.this["0"]
...
import {
  to = module.function_app_services.module.function_services_autoscale.azurerm_monitor_autoscale_setting.this
...
import {
  to = module.function_app_services.module.function_services_role_assignments.module.key_vault.azurerm_role_assignment.secrets["io-p-itn-com-rg-01|io-p-itn-com-kv-01|reader"]
...
import {
  to = module.function_app_services.module.function_services_staging_slot_role_assignments.module.key_vault.azurerm_role_assignment.secrets["io-p-itn-com-rg-01|io-p-itn-com-kv-01|reader"]
...
import {
  to = module.function_app_services.module.services_storage_account_01.azurerm_monitor_metric_alert.storage_account_health_check["0"]
...
import {
  to = module.function_app_services.module.services_storage_account_01.azurerm_private_endpoint.this["blob"]
...
import {
  to = module.function_app_services.module.services_storage_account_01.azurerm_private_endpoint.this["queue"]
...
import {
  to = module.function_app_services.module.services_storage_account_01.azurerm_storage_account.this
