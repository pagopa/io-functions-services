...
import { ACTIVATION_COLLECTION_NAME } from "@pagopa/io-functions-commons/dist/src/models/activation";
...
app.http("GetServiceActivation", {
  authLevel: "function",
  handler: GetServiceActivation(serviceModel, serviceActivationModel),
  methods: ["POST"],
