...
import { createClient } from "../generated/messages-services-api/client";
...
export const messagesServicesApiClient = createClient<"SubscriptionKey">({
  baseUrl: apimBaseUrl,
  fetchApi,
  // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
  withDefaults: (op) => (params) =>
    op({ ...params, SubscriptionKey: apimSubscriptionKey })
});

export type MessagesServicesApiClient = typeof messagesServicesApiClient;
